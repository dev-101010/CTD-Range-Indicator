...
export function init(container, canvasElement) {
...
export function mapLoaded(data) {
...
export function userTowerPlaced(data) {
...
export function towerMainValuesChanged(data) {
    const userID = data.user.uid;
...
export function towerStatsValuesChanged(data) {
    const userID = data.user.uid;
    const tower = towers.find(item => item.id === userID);
...
export function userTowerBeforeMove(data) {
    const userID = data.user.uid;
    const index = towers.findIndex(item => item.id === userID);
    if (index !== -1) towers.splice(index, 1);
    drawAll();
...
export function removeTower(data) {
    const userID = data.user.uid;
    const index = towers.findIndex(item => item.id === userID);
    if (index !== -1) towers.splice(index, 1);
    drawAll();
